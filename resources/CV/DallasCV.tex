...
\item {\mefont Dallas, T}, BA Melbourne, and A Hastings. 2018. When can competition and dispersal lead to checkerboard distributions? (in press at \textit{Journal of Animal Ecology})

\item {\mefont Dallas, T} and A Hastings. 2018. Habitat suitability estimated by niche models is largely unrelated to species abundance (in press at \textit{Global Ecology and Biogeography})

\item {\mefont Dallas, T}, S Budischak, C Carlson, V Ezenwa, B Han, S Huang, AA Aguirre, and PR Stephens. 2018. Gauging support for macroecological patterns in helminth parasites (in press at \textit{Global Ecology and Biogeography})


\item {\mefont Dallas, T}, BA Han, CL Nunn, AW Park, PR Stephens, and JM Drake. 2018. Trait-based prediction of host species roles in parasite sharing networks. \textit{Oikos} doi: 10.1111/oik.05602
...
% \entry
% {\href{http://github.com/taddallas/NHMpredict}{\textbf{NHMpredict}} \ \ }
% {Programmatically access the PREDICTS database}
% {R package}
\end{entrylist}
...
%\begin{entrylist}
% \entry
% {Emory marine ecology field course}
% {Assisted Dr. Keough in field course for her marine ecology class} 
% {Co-instructor}
%\end{entrylist}
...
For information on my service as a reviewer, see my {\href{https://publons.com/author/904038/tad-dallas#profile}{Publons page}. I have served as a reviewer for the following journals:
...
\begin{itemize}
 ...
 \item  {\href{http://disease_macroecology.ecology.uga.edu/}{Macroecology of Infectious Disease - NSF Research Coordination Network}}
...
\begin{entrylist}
 \entry
 {2014}
 {Best student paper award - Odum School of Ecology}
 {Applied category}
 ...
 \entry
 {2014}
 {Presentation award (4${th}$ place)}
 {Odum School Graduate Student Symposium}

 \entry
 {2012 - 2014 \ \ \ \ \ }
 {Odum School small grant recipient}
